...
const experiences = [
  {
    ...
    icon: meta,
    iconBg: "#383E56",
    date: ".  organize and manage         .",
    points: [
      "Technical Secretary: Lohith S","Administrative Secretary: Mehul Dinesh S",
    ],
  },
  {
    ...
    icon: advisor,
    iconBg: "#383E56",
    date: "support and guide         .",
    points: [
      "Technical Advisor: Aaditya Rengarajan","Administrative Advisor: Soorya Subramani",
    ],
  },
  {
    title: "Events Management",
    company_name: "Lead by Neelesh Padmanabh",
    icon: event,
    iconBg: "#383E56",
    date: ".  plan and execute         .",
    points: [
      "Thrisha Ravikumar","Trisha J","Akhil Ramalingam",
    ],
  },
  {
    title: "Publicity and Design",
    company_name: "Lead by Atul Krishnaa",
    icon: instagram,
    iconBg: "#383E56",
    date: "communicate         .",
    points: [
  ...
  },
  {
    ...
    company_name: "Lead by Dinesh TM",
    icon: web,
    iconBg: "#383E56",
    date: ".  equip and support         .",
    points: [
  ...
  },
  {
    ...
    company_name: "Lead by Arun US",
    icon: ai,
    iconBg: "#383E56",
    date: "explore and innovate         .",
    points: [
  ...
  // {
  //   title: "Cyber",
  //   company_name: "Head: Manoj Kumar",
  //   icon: cybersecurity,
  //   iconBg: "#383E56",
  //   date: "XXXX",
  //   points: [
  //     "The Cybersecurity Team, headed by Manoj Kumar is responsible for developing robust cybersecurity solutions and initiatives. The team actively shares their expertise by conducting educative seminars on a cybersafe community, empowering the club with knowledge and strategies to navigate the ever-changing cybersecurity landscape.",
  //   ],
  // },
  // {
  //   title: "WEB DEVELOPMENT",
  //   company_name: "Head: Udith Akash RR",
  //   icon: webdevelopment,
  //   iconBg: "#383E56",
  //   date: "XXXX",
  //   points: [
  //     "The Wed Development Team, headed by Udith Akash RR is responsible for shaping the club's online presence through innovative web-dev projects. The web-dev team creates event registration sites and custom platforms for conducting CTFs, hackathons and quizzes.",
  //   ],
  // },
  // {
  //   title: "EVENTS AND SPONSORSHIPS",
  //   company_name: "Head: Richard Samuel D",
  //   icon: meta,
  //   iconBg: "#383E56",
  //   date: "XXXX",
  //   points: [
  //     "The Eye organizes Tech-based events - like workshops, hackathons and treasure-hunts. The Events and Sponsorships team, headed by Richard Samuel D, are responsible for ideating and conducting events, as well as acquiring sponsors for conducting inter-college events.",
  //   ],
  // },
  // {
  //   title: "PUBLICITY AND DESIGN",
  ...
  //   date: "XXXX",
  //   points: [
  //     "The Publicity and Design Team, headed by Mehul Dinesh, is the creative force behind crafting visually stunning narratives that elevate our club's presence. This dynamic team specializes in designing posters that seamlessly blends aesthetics with communication. They also take charge of our club's social media, strategically leveraging platforms to bring attention to events and initiatives.",
  //   ],
  // },
  // {
  //   title: "OSINT",
